  ...
  return (
    <div>
      ...
      <div className="flex flex-col sm:flex-row gap-2.5">
        <button
          onClick={onAcceptAll}
          className="sm:flex-none bg-indigo-500 hover:bg-indigo-600 text-white text-[13px] font-semibold rounded-full px-5 py-2.5 transition-colors"
        >
          Accept all
        </button>
        <button
  ...
  return (
    <div>
      ...
      <div className="mt-6 pt-5 border-t border-slate-100">
        <button
          onClick={onSave}
          className="bg-indigo-500 hover:bg-indigo-600 text-white text-[13px] font-semibold rounded-full px-6 py-2.5 transition-colors"
        >
          Save preferences
        </button>
      </div>
...
function ToggleRow({
  ...
  return (
    <div className="flex items-start gap-4 py-4">
      ...
      {disabled ? (
        <span className="text-[11px] font-semibold text-indigo-500 uppercase tracking-[0.06em] mt-0.5 flex-shrink-0 whitespace-nowrap">
          Always on
        </span>
      ) : (
  ...
  return (
    <span className="inline-flex items-center justify-center flex-shrink-0 min-w-[44px] min-h-[44px]">
      <button
        ...
        onClick={onChange}
        className={`relative w-10 h-6 rounded-full transition-colors duration-200 focus:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500 focus-visible:ring-offset-2 ${
