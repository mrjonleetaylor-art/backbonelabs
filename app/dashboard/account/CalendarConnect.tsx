      ...
      {isConnected ? (
        ...
        <div className="flex items-center justify-between">
          ...
          <a
            ...
            className="inline-flex items-center gap-1.5 text-[13px] font-medium text-white bg-[#1E3A5F] hover:bg-[#1E3A5F] transition-colors rounded-lg px-3.5 py-2 leading-none"
          >
