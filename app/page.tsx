      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "FAQPage",
            "mainEntity": [
              { "@type": "Question", "name": "What happens when someone calls?", "acceptedAnswer": { "@type": "Answer", "text": "RelayDesk answers in two rings, greets the caller using your shop name, and handles the conversation from there. It takes orders, answers common questions, collects contact details, and sends you a summary after every call. Callers get a natural, helpful experience - and you don't miss a thing." } },
              ...
              { "@type": "Question", "name": "Can I customise what RelayDesk says?", "acceptedAnswer": { "@type": "Answer", "text": "Absolutely. We configure RelayDesk with your shop name, products, hours, pricing, and FAQs. The setup takes about 30 minutes, and most clients are live within 48 hours." } },
              ...
              { "@type": "Question", "name": "How are call recordings and customer details handled?", "acceptedAnswer": { "@type": "Answer", "text": "Every call is logged and summarised. Recordings and data are stored securely and accessible only to you." } },
              ...
              { "@type": "Question", "name": "What does setup require from me?", "acceptedAnswer": { "@type": "Answer", "text": "About an hour of your time. We configure everything - your services, hours, pricing, and call rules. Most businesses are live within a week." } },
              ...
              { "@type": "Question", "name": "What happens if there are connection issues or the server is down?", "acceptedAnswer": { "@type": "Answer", "text": "If RelayDesk is unreachable for any reason, calls are automatically re-routed to a voicemail. You will receive a notification and can follow up with the caller directly." } },
